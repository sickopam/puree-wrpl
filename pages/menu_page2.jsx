        ...
        <div>
            ...
            <div className='grid grid-cols-2 gap-2 ml-10 my-6 h-screen '>
                <div>
                    ...
                    <p className='mt-4 text-sm font-medium'>Peach Purée</p>
                    <p className='text-sm font-semibold'>53.280</p>
                </div>
                <div>
                    <Image src={nanas} className='w-32'></Image>
                    <p className='mt-4 text-sm font-medium'>Potato Purée</p>
                    <p className='text-sm font-semibold'>22.300</p>
                </div>
                <div>
                    <Image src={mango} className='w-32'></Image>
                    <p className='mt-4 text-sm font-medium'>Mango Purée</p>
                    <p className='text-sm font-semibold'>30.000</p>
                </div>
                <div>
                    <Image src={kiwi} className='w-32'></Image>
                    <p className='mt-4 text-sm font-medium'>Kiwi Purée</p>
                    <p className='text-sm font-semibold'>50.180</p>
                </div>
                <div>
                    <Image src={kacang2} className='w-32'></Image>
                    <p className='mt-4 text-sm font-medium'>Peanut Purée</p>
                    <p className='text-sm font-semibold'>19.280</p>
                </div>
                <div>
